...
file_size = (720,400) # Assumes (1920x1080) mp4
 
# We want to save the output to a video file
output_filename = file_prefix + '_object_tracking.mp4'
output_frames_per_second = 29.97
...
def main():
  ...
  if success:
    ...
    while True:
      ...
      bounding_box = cv2.selectROI('MultiTracker', frame, from_center, 
        show_cross_hair) 
    ...
    for bbox in bounding_box_list:
      ...
      tracker = generate_tracker(type_of_tracker)
